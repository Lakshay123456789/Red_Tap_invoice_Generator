...
def header(header,pdf):
  ...
  pdf.drawString(30,800,"Red Tape ")
  pdf.setFont("Courier-Bold",11)
  pdf.drawString(30,785,"near SBI bank,")
  pdf.drawString(30,770,"main market indri,")
  pdf.drawString(30,755,"Pincode. 132041 Phone: 9856472315")
...
def footer(pdf,list):
  ...
  pdf.drawString(15,15,"Scan QR code for Applied Terms & Conditions. thank you for visiting")

def About():
  pdf=canvas.Canvas("C:\\InvoiceGenerator\\about.pdf")
  pdf.setFont("Courier-Bold",20)
  pdf.drawString(40,700,"Lakshay kamboj")
  pdf.setFont("Courier-Bold",15)
  pdf.drawString(40,650,"Student, ")
  pdf.drawString(40,630,"Computer Science & Engineering,")
  pdf.drawString(40,610,"college-Jai Parkash Mukand Lal Innovative Engineering & Technology Institute ,")
  pdf.drawString(40,590,"indri karnal , 132041")
  pdf.drawString(40,550,"Contact: Lakshaykamboj018@gmail.com")
  pdf.save()
